...
export default function StatusBar() {
    ...
    const { lastEvent, unlisten } = useTauriListen<ClientsUpdatedEvent>("clients-updated-event");
    ...
    return (
        <div className="status-bar">
            <div>{lastEvent?.length ?? 0} client(s) connected</div>
